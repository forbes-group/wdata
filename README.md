...
W-data format used for analyzing superfluid data generated by [W-SLDA Toolkit](https://wslda.fizyka.pw.edu.pl/).

This format was originally derived from the W-SLDA project led by
Gabriel Wlazlowski as documented here:

https://gitlab.fizyka.pw.edu.pl/gabrielw/wslda/-/wikis/W-data%20format
